...
export const ConfigProvider: FC<{ children: ReactNode, cssVariables: Record<string, string> }> = ({ children, cssVariables }) => {
  useEffect(() => {
    Object.keys(cssVariables).filter(cv => cssVariables[cv]).forEach(cv => {
