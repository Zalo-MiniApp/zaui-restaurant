    ...
    <Box mt="5">
      ...
      <Box mx="4" className="bg-white rounded-2xl text-center relative restaurant-detail-box" p="4" style={{ marginTop: -60 }}>
        ...
        <Box flex justifyContent="center" mt="0" py="3">
          <Button className="text-red-500" iconZMP="zi-location">
        ...
        <Box flex justifyContent="space-between" mb="0">
          <Button fill typeName="primary">Thông tin</Button>
          <Button typeName="tertiary">Thực đơn</Button>
          <Button typeName="tertiary">Đặt bàn</Button>
        </Box>
      </Box>
    </Box>
    <Box mx="4" mt="5">
...
function RestaurantPage({ zmproute }) {
  ...
  return <Page>
    {restaurant ? <RestaurantDetail restaurant={restaurant} /> : <Box flex flexDirection="column" justifyContent="center" alignItems="center">
